...
// Graphics
    ...
    void                                InitRenderableComponent(gfx::ShaderProgram const& shader, gfx::VertexBufferRef const& vertexBuffer);
    ...
    inline void                         SetShader(gfx::ShaderProgram const& program) { m_RenderableComponent->m_ShaderProgram = program; }
